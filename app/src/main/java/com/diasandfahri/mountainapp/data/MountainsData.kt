...
Selama abad 20 dan abad 21, Gunung Bromo telah meletus sebanyak beberapa kali, dengan interval waktu yang teratur, yaitu 30 tahun. Letusan terbesar terjadi 1974, sedangkan letusan terakhir terjadi pada 2016-sekarang.
            
Bagi penduduk sekitar Gunung Bromo, suku Tengger, Gunung Bromo/Gunung Brahma dipercaya sebagai gunung suci. Setiap setahun sekali masyarakat Tengger mengadakan upacara Yadnya Kasada atau Kasodo. Upacara ini bertempat di sebuah pura yang berada di bawah kaki Gunung Bromo dan dilanjutkan ke puncak Bromo. Upacara diadakan pada tengah malam hingga dini hari setiap bulan purnama sekitar tanggal 14 atau 15 pada bulan Kasodo (kesepuluh) menurut penanggalan Jawa.""".trimIndent(),
        """
...
Flora yang berada di wilayah Gunung Semeru beraneka ragam jenisnya tetapi banyak didominir oleh pohon cemara, akasia, pinus, dan jenis Jamuju. Sedangkan untuk tumbuhan bawah didominir oleh kirinyuh, alang-alang, tembelekan, harendong dan edelwiss putih. Edelwis juga banyak ditemukan di lereng-lereng menuju puncak Semeru. Terdapat pula beberapa jenis anggrek endemik yang hidup di sekitar Gunung Semeru bagian selatan.
...
Pada 4 Desember 2021 pukul 15.10 WIB, Gunung Semeru meletus dan mengeluarkan guguran awan panas mengarah ke Besuk Kobokan, Desa Sapiturang, Kecamatan Pronojiwo. Guguran lava melaju dengan jarak luncur 500-800 meter, dengan pusat guguran 500 meter di bawah kawah. Sedangkan, gempa vulkanik yang berkaitan dengan letusan, guguran dan hembusan asap kawah telah terjadi sebanyak 54 kali gempa letusan atau erupsi, 4 kali gempa guguran, dan 18 kali gempa hembusan.

""".trimIndent(),
        """
Gunung Prahu (terkadang dieja Gunung Prau) (2.590 mdpl) terletak di kawasan Dataran Tinggi Dieng, Jawa Tengah, Indonesia. Gunung Prahu terletak pada koordinat 7°11′13″S 109°55′22″E. Gunung Prahu merupakan tapal batas antara empat kabupaten yaitu Kabupaten Batang, Kabupaten Kendal, Kabupaten Temanggung dan Kabupaten Wonosobo.
...
Pada hutan di lereng Gunung Prahu yang mengarah ke Kendal dan Batang yang masih lebat bisa dijumpai tumbuhan kantong semar/pitcher plants endemik Jawa yaitu Nepenthes gymnamphora yang banyak tumbuh bersama dengan pakis resam (Glichenia linearis). Di sekitar puncak ditemui bunga edelweis jawa (Anaphalis maxima dan Anaphalis longifolia). Di kawasan hutan Gunung Prahu juga masih bisa ditemui binatang khas jawa seperti macan tutul jawa (Panthera pardus melas), sigung jawa (Mydaus javanensis) dan elang jawa (Nisaetus bastelsi).
            
Setidaknya ada enam jalur yang umum digunakan untuk mendaki Gunung Prahu, yaitu:
...
Selain puncak, tempat yang sering dikunjungi adalah Segara Anakan, sebuah danau terletak di ketinggian 2.000m dpl. Untuk mencapai lokasi ini kita bisa mendaki dari desa Senaru atau desa Sembalun Lawang (dua entry point terdekat di ketinggian 600m dpl dan 1.150m dpl) di daerah Sembalun yang terkenal sebagai daerah perkebunan Ashitaba.
...
Keseluruhan perjalanan dapat dicapai dalam program tiga hari dua malam, atau jika hendak melihat dua objek lain: Gua Susu dan gunung Baru Jari (anak gunung Rinjani dengan kawah baru di tengah danau) perlu tambahan waktu dua hari perjalanan. Persiapan logistik sangat diperlukan. Disarankan untuk menggunakan jasa guide lokal yang berpengalaman untuk resiko tersesat dan tetap menghormati budaya adat setempat.
...
- Hutan Ericaceous > 1.500 meter""".trimIndent(),
        """
...
Banyak terdapat binatang khas Sumatra seperti gajah, badak sumatera, harimau, beruang madu, macan tutul, kecuali orang utan. Berbagai primata seperti siamang, gibbon, monyet ekor panjang, dan Presbytis melapophos. Terdapat juga 140 jenis burung.
...
Puncak ini merupakan gunung tertinggi di Indonesia kawasan Oceania. Puncak Jaya adalah salah satu dari tujuh puncak tertinggi di dunia.
...
Gunung Gede maupun kawasan Taman Nasional Gede Pangrango juga merupakan objek wisata alam yang menarik dan banyak dikunjungi oleh wisatawan baik domestik maupun internasional.Gunung Gede maupun kawasan Taman Nasional Gede Pangrango juga merupakan objek wisata alam yang menarik dan banyak dikunjungi oleh wisatawan baik domestik maupun internasional.
...
Untuk mencapai lokasi Taman Nasional Gede Pangrango bisa ditempuh melalui rute Jakarta-Bogor-Cibodas dengan waktu sekitar 2,5 jam (± 100 km) menggunakan mobil, atau Bandung-Cipanas-Cibodas dengan waktu 2 jam (± 89 km), dan Bogor-Salabintana dengan waktu 2 jam (52 km).""".trimIndent()
    )
